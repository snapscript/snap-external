...
import org.snapscript.cglib.CodeGenTestCase;
import org.snapscript.cglib.core.AbstractClassGenerator;
import org.snapscript.cglib.core.DefaultNamingPolicy;
import org.snapscript.cglib.core.NamingPolicy;
...
import org.snapscript.cglib.proxy.CallbackFilter;
import org.snapscript.cglib.proxy.CallbackHelper;
import org.snapscript.cglib.proxy.Enhancer;
import org.snapscript.cglib.proxy.Factory;
import org.snapscript.cglib.proxy.FixedValue;
import org.snapscript.cglib.proxy.InvocationHandler;
import org.snapscript.cglib.proxy.MethodInterceptor;
import org.snapscript.cglib.proxy.MethodProxy;
import org.snapscript.cglib.proxy.NoOp;
        ...
        ClassLoader custom = new ClassLoader(this.getClass().getClassLoader()) {
            ...
            public Class<?> loadClass(String name) throws ClassNotFoundException {
                if (EA.class.getName().equals(name)) {
                    InputStream classStream = this.getClass().getResourceAsStream("/org/snapscript/cglib/proxy/EA.class");
                    byte[] classBytes;
                    try {
  ...
  public void testCast()throws Throwable{
   ...
   public void testABC() throws Throwable{
    ...
    public void testBadNamingPolicyStillReservesNames() throws Throwable {
      ...
      e.setNamingPolicy(new NamingPolicy() {      
        public String getClassName(String prefix, String source, Object key, Predicate names) {
          return "org.snapscript.cglib.empty.Object$$ByDerby$$123";
        }
      });
    ...
    public void testNamingPolicyThatReturnsConstantNames() throws Throwable {
      Enhancer e = new Enhancer();
      final String desiredClassName = "org.snapscript.cglib.empty.Object$$42";
      e.setCallback(NoOp.INSTANCE);
      e.setClassLoader(new ClassLoader(this.getClass().getClassLoader()){});
      e.setNamingPolicy(new NamingPolicy() {
        public String getClassName(String prefix, String source, Object key, Predicate names) {

...
import org.snapscript.cglib.transform.*;
import org.snapscript.cglib.transform.impl.AddDelegateTransformer;
import org.snapscript.cglib.transform.impl.AddStaticInitTransformer;
import org.snapscript.cglib.transform.impl.FieldProvider;
import org.snapscript.cglib.transform.impl.FieldProviderTransformer;
import org.snapscript.cglib.transform.impl.InterceptFieldCallback;
import org.snapscript.cglib.transform.impl.InterceptFieldEnabled;
import org.snapscript.cglib.transform.impl.InterceptFieldFilter;
import org.snapscript.cglib.transform.impl.InterceptFieldTransformer;
...
public class TransformDemo {
   ...
   public static class Filter implements InterceptFieldFilter{
        ...
        public boolean acceptRead(org.snapscript.asm.Type owner, String name) {
                  return true;
        }
        
        public boolean acceptWrite(org.snapscript.asm.Type owner, String name) {
                  return true;
        }

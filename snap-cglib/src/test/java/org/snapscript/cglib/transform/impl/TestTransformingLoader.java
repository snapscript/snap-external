...
import org.snapscript.cglib.beans.*;
...
import org.snapscript.cglib.transform.impl.AddPropertyTransformer;
 ...
 */
public class TestTransformingLoader extends org.snapscript.cglib.CodeGenTestCase {

    private static final ClassFilter TEST_FILTER = new ClassFilter() {
        public boolean accept(String name) {
            System.err.println("Loading " + name);
            return name.startsWith("org.snapscript.cglib.");
        }
    };
    ...
    public void testAddStatic() throws Exception {
        Method m = ReflectUtils.findMethod("org.snapscript.cglib.transform.impl.TestTransformingLoader.initStatic(Class)");

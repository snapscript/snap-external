...
implements CallbackGenerator
{
    ...
    private static final Type REFLECT_UTILS =
      TypeUtils.parseType("org.snapscript.cglib.core.ReflectUtils");
    private static final Type METHOD_PROXY =
      TypeUtils.parseType("org.snapscript.cglib.proxy.MethodProxy");
    private static final Type METHOD_INTERCEPTOR =
      TypeUtils.parseType("org.snapscript.cglib.proxy.MethodInterceptor");

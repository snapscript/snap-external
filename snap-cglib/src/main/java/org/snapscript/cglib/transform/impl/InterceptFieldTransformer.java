...
public class InterceptFieldTransformer extends ClassEmitterTransformer {
    ...
    private static final Type CALLBACK =
      TypeUtils.parseType("org.snapscript.cglib.transform.impl.InterceptFieldCallback");
    private static final Type ENABLED =
      TypeUtils.parseType("org.snapscript.cglib.transform.impl.InterceptFieldEnabled");

...
import org.snapscript.cglib.core.ClassGenerator;
import org.snapscript.cglib.core.DefaultGeneratorStrategy;
import org.snapscript.cglib.core.GeneratorStrategy;
import org.snapscript.cglib.core.TypeUtils;
import org.snapscript.cglib.transform.ClassTransformer;
import org.snapscript.cglib.transform.MethodFilter;
import org.snapscript.cglib.transform.MethodFilterTransformer;
import org.snapscript.cglib.transform.TransformingClassGenerator;

/**
 * A {@link GeneratorStrategy} suitable for use with {@link org.snapscript.cglib.Enhancer} which

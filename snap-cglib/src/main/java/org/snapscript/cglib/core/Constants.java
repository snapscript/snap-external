 ...
 */
public interface Constants extends org.snapscript.asm.Opcodes {
    ...
    public static final Type TYPE_SIGNATURE = TypeUtils.parseType("org.snapscript.cglib.core.Signature");

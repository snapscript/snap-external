 ...
 */
package org.snapscript.cglib.beans;
...
class BulkBeanEmitter extends ClassEmitter {
    ...
    private static final Type BULK_BEAN =
      TypeUtils.parseType("org.snapscript.cglib.beans.BulkBean");
    private static final Type BULK_BEAN_EXCEPTION =
      TypeUtils.parseType("org.snapscript.cglib.beans.BulkBeanException");

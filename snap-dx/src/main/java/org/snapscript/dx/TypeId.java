...
public final class TypeId<T> {
    ...
    public static final TypeId<Boolean> BOOLEAN = new TypeId<Boolean>(org.snapscript.dx.rop.type.Type.BOOLEAN);

    /** The {@code byte} primitive type. */
    public static final TypeId<Byte> BYTE = new TypeId<Byte>(org.snapscript.dx.rop.type.Type.BYTE);

    /** The {@code char} primitive type. */
    public static final TypeId<Character> CHAR = new TypeId<Character>(org.snapscript.dx.rop.type.Type.CHAR);

    /** The {@code double} primitive type. */
    public static final TypeId<Double> DOUBLE = new TypeId<Double>(org.snapscript.dx.rop.type.Type.DOUBLE);

    /** The {@code float} primitive type. */
    public static final TypeId<Float> FLOAT = new TypeId<Float>(org.snapscript.dx.rop.type.Type.FLOAT);

    /** The {@code int} primitive type. */
    public static final TypeId<Integer> INT = new TypeId<Integer>(org.snapscript.dx.rop.type.Type.INT);

    /** The {@code long} primitive type. */
    public static final TypeId<Long> LONG = new TypeId<Long>(org.snapscript.dx.rop.type.Type.LONG);

    /** The {@code short} primitive type. */
    public static final TypeId<Short> SHORT = new TypeId<Short>(org.snapscript.dx.rop.type.Type.SHORT);

    /** The {@code void} primitive type. Only used as a return type. */
    public static final TypeId<Void> VOID = new TypeId<Void>(org.snapscript.dx.rop.type.Type.VOID);

    /** The {@code Object} type. */
    public static final TypeId<Object> OBJECT = new TypeId<Object>(org.snapscript.dx.rop.type.Type.OBJECT);

    /** The {@code String} type. */
    public static final TypeId<String> STRING = new TypeId<String>(org.snapscript.dx.rop.type.Type.STRING);
    ...
    final org.snapscript.dx.rop.type.Type ropType;
    final CstType constant;

    TypeId(org.snapscript.dx.rop.type.Type ropType) {
        this(ropType.getDescriptor(), ropType);
    }

    TypeId(String name, org.snapscript.dx.rop.type.Type ropType) {
    ...
    public static <T> TypeId<T> get(String name) {
        return new TypeId<T>(name, org.snapscript.dx.rop.type.Type.internReturnType(name));
    }
    ...
    public MethodId<T, Void> getStaticInitializer() {
        return new MethodId<T, Void>(this, VOID, "<clinit>", new TypeList(new TypeId[0]));
    }

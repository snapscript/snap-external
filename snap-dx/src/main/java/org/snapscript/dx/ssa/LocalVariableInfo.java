...
import org.snapscript.dx.util.MutabilityControl;

/**
 * Container for local variable information for a particular {@link
 * org.snapscript.dx.ssa.SsaMethod}.
 * Stolen from {@link org.snapscript.dx.rop.code.LocalVariableInfo}.
 */
public class LocalVariableInfo         extends MutabilityControl {
    ...
    /**
     * {@code non-null;} {@link org.snapscript.dx.rop.code.RegisterSpecSet} to use when indicating a block
     ...
     * {@link org.snapscript.dx.rop.type.TypeBearer} (such as a constant value).
     *
